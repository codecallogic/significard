...
export const manageCardTags = (initialize, data) => {
  const input = document.getElementById('researchInterests-card')
  const tagContainer = document.querySelector('.form-tag-container-card')
